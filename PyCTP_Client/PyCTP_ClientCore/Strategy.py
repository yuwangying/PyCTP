...
class Strategy(QtCore.QObject):
    ...
    def __init__(self, dict_args, obj_user, parent=None):
        ...
        self.__list_position_detail = list()  # 策略持仓明细列表，用order维护
        ...
        # 初始化策略持仓明细列表
        self.init_list_position_detail()
    ...
    def init_position(self):
        if len(self.__list_position_detail) == 0:
            return True
        elif len(self.__list_position_detail) > 0:
            for i in self.__list_position_detail:  # 遍历持仓明细列表
    ...
    def update_position(self, input_order):
        ...
        if Utils.Strategy_print:
            ...
            print("     A合约", self.__a_instrument_id, "今买、昨买、总买", self.__position_a_buy_today,
            ...
            print("     B合约", self.__b_instrument_id, "今买、昨买、总买", self.__position_b_buy_today,
    ...
    def init_statistics(self):
        ...
        self.__dict_statistics = {
            ...
            'close_profit': self.__close_profit,  # 平仓盈亏
            'commission': 0,  # 手续费
            # 'profit': 0,  # 净盈亏
            'volume': 0,  # 成交量
            'amount': 0,  # 成交金额
        ...
        self.__profit = self.__close_profit - self.__commission
        self.__dict_statistics = {
            # 'position_profit': 0,  # 持仓盈亏
            'close_profit': self.__close_profit,  # 平仓盈亏
    ...
    def count_close_profit(self, trade_close, trade_open):
        ...
        self.__close_profit += profit_close
