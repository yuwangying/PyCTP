...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableView_Trade_Args.setEnabled(True)
        self.tableView_Trade_Args.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.tableView_Trade_Args.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        ...
        self.tableView_Trade_Args.setShowGrid(True)
        self.tableView_Trade_Args.setGridStyle(QtCore.Qt.DashDotDotLine)
        self.tableView_Trade_Args.setObjectName(_fromUtf8("tableView_Trade_Args"))
        self.tableView_Trade_Args.horizontalHeader().setDefaultSectionSize(1)
        self.tableView_Trade_Args.verticalHeader().setVisible(False)
        self.tableView_Trade_Args.verticalHeader().setCascadingSectionResizes(False)
        self.tableView_Trade_Args.verticalHeader().setDefaultSectionSize(0)
        self.tableView_Trade_Args.verticalHeader().setHighlightSections(False)
        self.tableView_Trade_Args.verticalHeader().setSortIndicatorShown(True)
        self.horizontalLayout_container_trade.addWidget(self.tableView_Trade_Args)
...
"background-color: rgb(255, 255, 255);"))
        ...
        self.horizontalLayout_container_trade.setStretch(0, 12)
        self.horizontalLayout_container_trade.setStretch(1, 5)
